  ...
  return (
    <div className="min-h-screen flex">
      ...
      <motion.div 
        ...
        className="hidden lg:flex lg:w-1/2 relative bg-gradient-to-br from-indigo-600 via-purple-600 to-pink-500 overflow-hidden"
      >
        ...
        <div className="relative z-10 flex flex-col justify-between p-12 text-white w-full">
          ...
          >
            <p className="text-white/80 text-sm">
              Join over 10,000+ happy customers who trust Bagvo for premium quality bags
            </p>
          </motion.div>
        </div>
      </motion.div>
        ...
        <div className="max-w-md w-full space-y-8">
          ...
          <div>
            ...
            <p className="mt-2 text-sm text-gray-600">
              Join us and start shopping premium bags
            </p>
          </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  onChange={handleChange}
                  className="block w-full pl-10 pr-12 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all duration-200 text-sm"
                  placeholder="Min. 6 characters"
                />
                <button
                  type="button"
                  onClick={() => setShowPassword(!showPassword)}
                  className="absolute inset-y-0 right-0 pr-3 flex items-center hover:text-indigo-700 transition-colors"
                >
                  {showPassword ? (
